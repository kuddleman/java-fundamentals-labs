...
public class Exercise_01 {
    ...
    public static void main(String[] args) {
        ...
        // write code here
        int a = 10;
        double d = 23455643.4566d;
        float f = 23.4565f;
        char c = 'c';

        System.out.println("Here is the integer: " + a);
        System.out.println("Here is the double: " + d);
        System.out.println("Here is the float: " + f);
        System.out.println("Here is the char: " + c);
